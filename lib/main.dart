...
import 'package:northladder_test_app/screens/landing_page.dart';
    ...
    MultiProvider(
      providers: [
        ChangeNotifierProvider<CountryChangeNotifier>(
          create: (_) => CountryChangeNotifier(),
        ),
        ChangeNotifierProvider<DeviceChangeNotifier>(
          create: (_) => DeviceChangeNotifier(),
        ),
        ChangeNotifierProvider<CategoryChangeNotifier>(
          create: (_) => CategoryChangeNotifier(),
        ),
        ChangeNotifierProvider<ModelChangeNotifier>(
          create: (_) => ModelChangeNotifier(),
        )
      ],
      child: const MyApp(),
    ),
